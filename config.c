		      ...
		      int protocol, int protcfginfo, int session_storagetype) // HACK: PuttyTray / PuTTY File - Added 'int session_storagetype'
{
    ...
    ctrl_radiobuttons(s, "Background Style:", NO_SHORTCUT, 3,
              ...
              "Solid Color", NO_SHORTCUT, I(0),  // TODO: Define shortcuts for these.
              "Like Desktop", NO_SHORTCUT, I(1),
              "Image File", NO_SHORTCUT, I(2),
              NULL);
    ctrl_checkbox(s, "Update background while moving window", 'b',
		  HELPCTX(appearance_background),
		  dlg_stdcheckbox_handler, I(offsetof(Config,bg_update_moving)));
